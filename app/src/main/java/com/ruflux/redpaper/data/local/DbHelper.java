...
public class DbHelper extends SQLiteOpenHelper {
    ...
    public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
        ...
        db.execSQL(SubModel.CLEARSUBTABLE);
        db.execSQL(PostModel.CLEARPOSTTABLE);
        db.execSQL(ResolutionModel.CLEARRESOLUTIONTABLE);
        db.execSQL(SourceModel.CLEARSOURCETABLE);
